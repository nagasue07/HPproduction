window.onload = function() {
    const meatTitle = document.getElementById('meat-title');
    const featuredDish = document.querySelector('.featured-dish');
    const menuItems = document.querySelectorAll('.menu-item');
    const menuTexts = document.querySelectorAll('.menu-item h2, .menu-item p, .price');
    
    // お肉料理タイトルを表示
    setTimeout(() => {
        meatTitle.classList.add('fade-in');
    }, 500);
